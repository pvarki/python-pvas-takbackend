...
PIPELINE_URL: str = cfg(
    "PIPELINE_URL", default="https://dev.azure.com/pvarki/PVARKI/_apis/pipelines/10/runs?api-version=7.0"
)
PIPELINE_REF: str = cfg("PIPELINE_REF", default="refs/heads/main")
...
INSTRUCTIONS_RECEIVER_EMAIL: str = cfg("INSTRUCTIONS_RECEIVER_EMAIL", default="paavo.pokkinen@hallatek.com")
